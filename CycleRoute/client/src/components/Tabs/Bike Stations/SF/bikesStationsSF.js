...
import SingleBikeStationSF from './singleBikeStationSF';
import "../bikeStations.css";

const BikeStationsSF = () => {
    ...
    <div>
      ...
      <div className='allstations'>
        ...
        {station.map((station, index) => {
          return (
            <SingleBikeStationSF key={index} singleBikeStationSF={station} />
          )
        }
        )}
